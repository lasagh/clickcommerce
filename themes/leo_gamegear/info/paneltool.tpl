    ...
    <div class="panelbutton">
      ...
      <div class="panelcontent ">
          <div class="panelinner">
            ...
            {/if}
            <div class="group-input clearfix">
              <label class="col-sm-3 control-label">{l s='Float Header'}</label>
              <div class="col-sm-9">
                <span class="enable_fheader {if $USE_FHEADER}current{/if}" data-value="1">
                  {l s='Yes'}
                </span>
                <span class="enable_fheader {if !$USE_FHEADER}current{/if}" data-value="0">
                  {l s='No'}
                </span>
              </div>
            </div>

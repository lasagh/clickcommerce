...
function actionOnPaymentSelect(element){
    ...
    if(payment_module_name != 'moip' && payment_module_name != 'paypalpro' && payment_module_name != 'stripejs' && payment_module_name != 'firstdata' && payment_module_name != 'migs' && payment_module_name != 'conektatarjeta' && payment_module_name != 'stripepro' && payment_module_name != 'braintreejs_backup' && payment_module_name != 'twocheckout' && payment_module_name != 'brinkscheckout' && payment_module_name != 'ewayrapid' && payment_module_name != 'npaypalpro' && payment_module_name != 'authorizeaim'){
			$('#selected_payment_method_html').html(''); // to hide form if customer select any other payment method later
		}
    if(payment_module_name == 'librapay' || payment_module_name == 'codpro' || payment_module_name == 'bankwirepro'|| payment_module_name == 'cashonpickup' || payment_module_name == 'dibs' || payment_module_name == 'klarnaofficial' || payment_module_name == 'cashondeliveryplus' || payment_module_name == 'ebs' || payment_module_name == 'virtualmerchant' || payment_module_name == 'lc_paywithfee' || payment_module_name == 'klikandpay' || payment_module_name == 'transferuj' || payment_module_name == 'eanpayment' || payment_module_name == 'prepayment' || payment_module_name == 'ecm_privat24' || payment_module_name == 'xpay' || payment_module_name == 'cashondelivery' || payment_module_name == 'mollie_ideal' || payment_module_name == 'mollie_mistercash' || payment_module_name == 'mollie_belfius' || payment_module_name == 'mollie_paypal' || payment_module_name == 'payeer' || payment_module_name == 'western' || payment_module_name == 'bankwirepluss' || payment_module_name == 'authorizedotnet' || payment_module_name == 'secureframe' || payment_module_name == 'compropago' || payment_module_name == 'checkout' || payment_module_name == 'westernunion' || payment_module_name == 'billmateinvoice' || payment_module_name == 'billmatepartpayment' || payment_module_name == 'mercadoc' ||payment_module_name == 'boletosantanderpro' || payment_module_name == 'payu' || payment_module_name == 'payulatam' || payment_module_name == 'zipcheck' || payment_module_name == 'megareembolso' || payment_module_name == 'payinstore' || payment_module_name == 'codfee' || payment_module_name == 'finanziamento' || payment_module_name == 'megashoppay' ){
    ...
    }else if(payment_module_name == 'stripejs' || payment_module_name == 'cmcic' || payment_module_name == 'stripepro' || payment_module_name == 'paypalpro' || payment_module_name == 'firstdata' || payment_module_name == 'migs' || payment_module_name == 'conektatarjeta' || payment_module_name == 'braintreejs_backup' || payment_module_name == 'twocheckout' || payment_module_name == 'brinkscheckout' || payment_module_name == 'ewayrapid' || payment_module_name == 'npaypalpro' ||  payment_module_name == 'mobilpay_cc' || payment_module_name == 'authorizeaim' || payment_module_name == 'khipupayment' || payment_module_name == 'paynl_paymentmethods' || payment_module_name == 'mollie' || payment_module_name == 'quickpay' || payment_module_name == 'custompaymentmethod' || payment_module_name == 'cofidis' || payment_module_name == 'mpar' || payment_module_name == 'moneybookers' || payment_module_name == 'mercadopagobr' || payment_module_name == 'djtalmoip' || payment_module_name == 'atos' || payment_module_name == 'payline' || payment_module_name == 'winbnk' || payment_module_name == 'faspay' || payment_module_name == 'paynlpaymentmethods' || payment_module_name == 'add_gopay_new' || payment_module_name == 'banc_sabadell' || payment_module_name == 'be2bill' || payment_module_name == 'py_atos' || payment_module_name == 'payway' || payment_module_name == 'paypal' || payment_module_name == 'ggbank' || payment_module_name == 'clickcanarias' || payment_module_name == 'mobilpay_cc' || payment_module_name == 'parspalpayment' || payment_module_name == 'pronesis_bancasella' || payment_module_name == 'paypalmx' || payment_module_name == 'cmcic_tbweb' || payment_module_name == 'sisoweb' || payment_module_name == 'citrus' || payment_module_name == 'banc_sabadell' || payment_module_name == 'ccavenue' || payment_module_name == 'ogone' || payment_module_name == 'epay' || payment_module_name == 'creditcardpaypal' || payment_module_name == 'paypalusa' || payment_module_name == 'sisowideal' || payment_module_name == 'paypalwithfee' || payment_module_name == 'sisowmc'){
...
function getPaymentForm1(element){
    ...
    $.ajax({
		...
		$('#asubmit').hide();
            }else if(payment_module_name == 'moip' || payment_module_name == 'stripejs' || payment_module_name == 'stripepro' || payment_module_name == 'paypalpro' || payment_module_name == 'firstdata' ||payment_module_name == 'migs' || payment_module_name == 'conektatarjeta' || payment_module_name == 'braintreejs_backup' || payment_module_name == 'brinkscheckout' || payment_module_name == 'twocheckout'){
		...
		$('.paypalpro-submit-button').hide();
            }else if(payment_module_name == 'cofidis' || payment_module_name == 'custompaymentmethod' || payment_module_name == 'moneybookers' || payment_module_name == 'djtalmoip' || payment_module_name == 'atos' || payment_module_name == 'payline' || payment_module_name == 'winbnk' || payment_module_name == 'faspay' || payment_module_name == 'paynlpaymentmethods' ||  payment_module_name == 'add_gopay_new' ||  payment_module_name == 'quickpay' || payment_module_name == 'mollie' || payment_module_name == 'paynl_paymentmethods'){
                    ...
                    if(extrasError){
                        ...
                        if(is_free_order){
                            ...
                            if($('input:radio[name="payment_method"]:checked').length){
                                ...
                                if(p_m_name == 'moip' || p_m_name == 'isicmcic' || p_m_name == 'stripejs' || p_m_name == 'stripepro' || p_m_name == 'paypalpro' || p_m_name == 'firstdata' || p_m_name == 'migs' || p_m_name == 'conektatarjeta' || p_m_name == 'braintreejs_backup' || p_m_name == 'twocheckout' || p_m_name == 'brinkscheckout' || p_m_name == 'ewayrapid' || p_m_name == 'npaypalpro' ||  p_m_name == 'authorizeaim' || p_m_name == 'librapay' || p_m_name == 'secureframe' || p_m_name == 'bankwirepro' || p_m_name == 'codpro' || p_m_name == 'cashonpickup' || p_m_name == 'dibs' || p_m_name == 'klarnaofficial' || p_m_name == 'cashondeliveryplus' || p_m_name == 'bankwireplus' || p_m_name == 'ebs' || p_m_name == 'virtualmerchant' || p_m_name == 'cs_cardsave' || p_m_name == 'lc_paywithfee' || p_m_name == 'klikandpay' || p_m_name == 'transferuj' || p_m_name == 'eanpayment' || p_m_name == 'prepayment' || p_m_name == 'ecm_privat24' || p_m_name == 'xpay' || p_m_name == 'cashondelivery' || p_m_name == 'mollie_ideal' || p_m_name == 'mollie_mistercash' || p_m_name == 'mollie_belfius' || p_m_name == 'mollie_paypal' || p_m_name == 'western' || p_m_name == 'payeer' || p_m_name == 'authorizedotnet' || p_m_name == 'compropago' || p_m_name == 'checkout' || p_m_name == 'westernunion' || p_m_name == 'billmatepartpayment' || p_m_name == 'billmateinvoice' || p_m_name == 'paysondirect' || p_m_name == 'mercadoc' || p_m_name == 'boletosantanderpro' || p_m_name == 'payu' || p_m_name == 'megashoppay' || p_m_name == 'zipcheck' || p_m_name == 'megareembolso' || p_m_name == 'payinstore' || p_m_name == 'codfee' || p_m_name == 'obsredsys' || p_m_name == 'hipay' || p_m_name == 'psphipay' || p_m_name == 'finanziamento' || p_m_name == 'cecatpv' || p_m_name == 'dineromail' || p_m_name == 'payulatam' || p_m_name == 'cuatrob'){
                                    moveToPayment();
                                }else{
                                    actionOnPaymentSelect($('input:radio[name="payment_method"]:checked'));
                                }
...
function moveToPayment(){
    ...
    }else if(p_m_name == 'khipupayment' || p_m_name == 'paynl_paymentmethods' || p_m_name == 'mollie' || p_m_name == 'custompaymentmethod' || p_m_name == 'cofidis' || p_m_name == 'moneybookers' || p_m_name == 'mercadopagobr' || p_m_name == 'faspay' || p_m_name == 'paynlpaymentmethods' || p_m_name == 'epay' || p_m_name == 'quickpay'){
            createPaymentPop();
		if (p_m_name != 'custompaymentmethod')
		    $('#velsof_payment_dialog .velsof_action_section').show(); // @nitin 27 July - Important to show proceed button if it is hide in previous payment method selection	    
	...
	location.href = $('#'+$('input:radio[name="payment_method"]:checked').attr('value')+'_name').val();
	}else if(p_m_name == 'bankwire' || p_m_name == 'mercadopago' || p_m_name == 'add_bankwire' ||  p_m_name == 'gestpay' || p_m_name == 'GPWebPayBinder' || p_m_name == 'pscodfee' || p_m_name == 'bluesnap' || p_m_name == 'koin' || p_m_name == 'payuc' || p_m_name == 'lc_paywithfee' || p_m_name == 'lc_paywithfee' || p_m_name == 'add_dobirka_fee' || p_m_name == 'postfinancecw_postfinanceefinance' || p_m_name == 'postfinancecw_creditcard' || p_m_name == 'postfinancecw_postfinancecard' || p_m_name == 'lemonway' || p_m_name == 'sagepay' || p_m_name == 'SagePay' || p_m_name == 'klarnaofficial' || p_m_name == 'dibs' || p_m_name == 'ebs' || p_m_name == 'cashonpickup' ||  p_m_name == 'cpay' || p_m_name == 'cminvoicepay' || p_m_name == 'swipp' || p_m_name == 'boleto' || p_m_name == 'pstransparenteloja5' || p_m_name == 'spsbradesco' || p_m_name == 'cielows' || p_m_name == 'edinar' || p_m_name == 'clictopay' || p_m_name == 'allpay' || p_m_name == 'pay2go' || p_m_name == 'cash' || p_m_name == 'postfinance' || p_m_name == 'pagseguro' || p_m_name == 'braintreejs' || p_m_name == 'bcash' || p_m_name == 'invoicepayment' || p_m_name == 'przelewy24' || p_m_name == 'prestalia_cashondelivery' ||  p_m_name == 'virtpaypayment' || p_m_name == 'cashondeliveryfeeplus' || p_m_name == 'pagonlineimprese' || p_m_name == 'mokejimai' || p_m_name == 'payplug' || p_m_name == 'seurcashondelivery' || p_m_name == 'cashondeliveryplus' || p_m_name == 'universalpay' || p_m_name == 'mandiri' || p_m_name == 'bni' || p_m_name == 'bca' || p_m_name == 'veritranspay' || p_m_name == 'przelewy24' || p_m_name == 'transbancaria' || p_m_name == 'cashondeliveryplusmax' || p_m_name == 'multibanco' || p_m_name == 'ceca' || p_m_name == 'dotpay' || p_m_name == 'postepay' || p_m_name == 'paypaladvanced' || p_m_name == 'trustly' || p_m_name == 'billmateinvoice' || p_m_name == 'billmatepartpayment' || p_m_name == 'cheque' || p_m_name == 'westernunion' ||  p_m_name == 'paysondirect' || p_m_name == 'mercadoc' || p_m_name == 'boletosantanderpro' || p_m_name == 'payu' ||  p_m_name == 'librapay' ||  p_m_name == 'secureframe' || p_m_name == 'codpro' || p_m_name == 'bankwirepro'|| p_m_name == 'cashonpickup' || p_m_name == 'klarnaofficial' || p_m_name == 'dibs' || p_m_name == 'cashondeliveryplus' || p_m_name == 'bankwireplus' || p_m_name == 'ebs' || p_m_name == 'virtualmerchant' || p_m_name == 'lc_paywithfee' || p_m_name == 'klikandpay' || p_m_name == 'transferuj' || p_m_name == 'eanpayment' || p_m_name == 'prepayment' || p_m_name == 'ecm_privat24' || p_m_name == 'xpay' || p_m_name == 'cashondelivery' || p_m_name == 'mollie_ideal' || p_m_name == 'mollie_mistercash' || p_m_name == 'mollie_belfius' || p_m_name == 'mollie_paypal' || p_m_name == 'payeer' || p_m_name == 'western' || p_m_name == 'authorizedotnet' || p_m_name == 'compropago' || p_m_name == 'checkout' || p_m_name == 'megashoppay' || p_m_name == 'payulatam' || p_m_name == 'zipcheck' || p_m_name == 'megareembolso' || p_m_name == 'deluxecodfees' || p_m_name == 'payinstore' || p_m_name == 'codfee' || p_m_name == 'obsredsys' || p_m_name == 'hipay' || p_m_name == 'psphipay' || p_m_name == 'finanziamento'){
	...
	}else if(p_m_name == 'moip'){
	    hide_progress(); // to hide progress bar in case some error occur in first data payment form
            if($('input:radio[name="payment"]:checked').val() == 'Credito')
                $('#CartaoCredito').trigger('click');
	    if($('input:radio[name="payment"]:checked').val() == 'Debito')
                $('#DebitoBancario').trigger('click');
            if($('input:radio[name="payment"]:checked').val() == 'Boleto')
	    $('#BoletoBancario').trigger('click');

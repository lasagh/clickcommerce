...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_583c6b35caf5b6_11757887',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583c6b35caf5b6_11757887')) {function content_583c6b35caf5b6_11757887($_smarty_tpl) {?>
            <div class="row" 
                    >
			...
			<a href="http://localhost:8888/clickcommerce/vp1/pedido" title="Ver meu carrinho de compras" rel="nofollow">
				...
				<div class="block_content">
					...
					<div class="cart_block_list">
													<dl class="products">
																																			<dt data-id="cart_block_product_2_7_5" class="first_item">
										<a class="cart-images" href="http://localhost:8888/clickcommerce/vp1/blusas/2-blusa.html" title="Blusa"><img src="http://localhost:8888/clickcommerce/vp1/7-cart_default/blusa.jpg" alt="Blusa" /></a>
										<div class="cart-info">
											<div class="product-name"><a class="cart_block_product_name" href="http://localhost:8888/clickcommerce/vp1/blusas/2-blusa.html#/size-p/color-preto" title="Blusa">Blusa</a>
												<span class="quantity-formated">&nbsp;x&nbsp;<span class="quantity">1</span></span>
												
											<span class="price">
																									R$ 33,75                                                    <div class="hookDisplayProductPriceBlock-price">
                                                        
                                                    </div>
																							</span>
											</div>
																							<div class="product-atributes">
													<a href="http://localhost:8888/clickcommerce/vp1/blusas/2-blusa.html#/size-p/color-preto" title="Detalhe do produto">P, Preto</a>
												</div>
																					</div>
										<span class="remove_link">
																							<a class="ajax_cart_block_remove_link" href="http://localhost:8888/clickcommerce/vp1/carrinho?delete=1&amp;id_product=2&amp;ipa=7&amp;id_address_delivery=5&amp;token=5c2f17a0392e84a7b7394156eeab4c5a" rel="nofollow" title="Retirar este produto do meu carrinho"><i class="fa fa-trash-o"></i></a>
																					</span>
									</dt>
																			<dd data-id="cart_block_combination_of_2_7_5" class="first_item">
																		<!-- Customizable datas -->
																		</dd>															</dl>
							...
							<div class="cart-prices-line first-line">
								...
								<span class="price cart_block_total ajax_block_cart_total">R$ 33,75</span>
								<span>Total</span>
							</div>
													</div>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				<span class="title">
					...
					<span class="ajax_cart_product_txt_s  unvisible">
						Existem <span class="ajax_cart_quantity">1</span> produtos no seu carrinho.
					</span>

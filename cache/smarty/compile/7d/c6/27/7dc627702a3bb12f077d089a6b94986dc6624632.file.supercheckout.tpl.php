<?php /* Smarty version Smarty-3.1.19, created on 2016-11-28 15:33:16
         compiled from "/Applications/MAMP/htdocs/clickcommerce/vp1/modules/supercheckout/views/templates/admin/supercheckout.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1706691354583c6a5c62ec97-52146163%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7dc627702a3bb12f077d089a6b94986dc6624632' => 
    array (
      0 => '/Applications/MAMP/htdocs/clickcommerce/vp1/modules/supercheckout/views/templates/admin/supercheckout.tpl',
      1 => 1456428766,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1706691354583c6a5c62ec97-52146163',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583c6a633ea815_52590949',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583c6a633ea815_52590949')) {function content_583c6a633ea815_52590949($_smarty_tpl) {?>
            ...
            <div class="widget velsof-widget-left">
                <div class="widget-body velsof-widget-left">                    
                                ...
                                <div class="slimScrollDiv">
                                    <div class="slim-scroll">
                                        <ul>
                                            ...
                                            <li class="<?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>vss-tab-ver15<?php }?>"><a class="glyphicons keys" id="velsof_tab_login" href="#tab_login" data-toggle="tab"><i></i><span><?php echo smartyTranslate(array('s'=>'Login','mod'=>'supercheckout'),$_smarty_tpl);?>
</span></a></li>                                            
					    ...
					    <li class="<?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>vss-tab-ver15<?php }?>"><a class="glyphicons shopping_cart" href="#tab_cart" data-toggle="tab"><i></i><span><?php echo smartyTranslate(array('s'=>'Cart','mod'=>'supercheckout'),$_smarty_tpl);?>
                                            ...
                                            <li class="<?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>vss-tab-ver15<?php }?>"><a class="glyphicons bookmark" target="_blank" href="http://addons.prestashop.com/en/2_community-developer?contributor=38002" target="_blank"><i></i><span><?php echo smartyTranslate(array('s'=>'Other Plugins','mod'=>'supercheckout'),$_smarty_tpl);?>
</span></a></li>
                                        </ul>
...
" value="1" >
                                            <input type="hidden" name="velocity_supercheckout[adv_id]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['adv_id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" >
                                            <input type="hidden" name="velocity_supercheckout[temp_cart_image_size][width]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['cart_image_size']['width'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                            <input type="hidden" name="velocity_supercheckout[temp_cart_image_size][height]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['cart_image_size']['height'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"></i>
								...
								<tr><td class="name vertical_top_align"><span class="control-label"><?php echo smartyTranslate(array('s'=>'Delivery address for virtual cart','mod'=>'supercheckout'),$_smarty_tpl);?>
: </span>
                                                                        ...
                                                                        <td class="left settings">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                <label class="radio coupon_type_radio">
                                                                                    <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[checkout_option]" value="0"  <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['checkout_option']==0) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Login','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                                </label>
                                                                                <label class="radio coupon_type_radio">
                                                                                    <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[checkout_option]" value="1" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['checkout_option']==1) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Guest','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                                </label>
                                                                                <label class="radio coupon_type_radio">
                                                                                    <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[checkout_option]" value="2" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['checkout_option']==2) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Register','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                    ...
                                                                    <tr id="front_module_url" style="display: none;">
                                                                        <td colspan="2">
                                                                            <div class="span" style="padding:20px;">
                                                                                 <div>
                                                                                    <div style="float:left;"><b><?php echo smartyTranslate(array('s'=>'Testing URL','mod'=>'supercheckout'),$_smarty_tpl);?>
:</b></div>
										    
										    
                                                                                    <div style="float:left;width: 400px;border-radius: 3px;margin-left: 10px;border: 1px solid #E2E2E2;padding: 5px;">
											<input disabled type="text" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['module_url']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" id="testurlfield">
										    </div> 
										    <div style="
    float: left;
...
"></div>
									 ...
									 <div style= "  text-align:center;padding: 25px; height:140px;margin: 40px;margin-bottom:0px; background: aliceblue;<?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>height: 90px;<?php }?>">
                                                        <div><span style="font-size:18px;">Know exactly when customers left checkout page.</span>
                                                        <br>
                                                        <br>
                                                         <a target="_blank" href="http://addons.prestashop.com/en/analytics-statistics/21484-knowband-analytics-for-checkout-page.html"><span style="margin-left:30%;max-width:40% !important;font-size:18px;" class='btn btn-block btn-success action-btn'>Click here to know more</span></a><div>
                                                            </div>
...
"></i>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input" onchange="bg_changer(this.color);" name="velocity_supercheckout[customizer][button_color]"  value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customizer']['button_color'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input"  onchange="border_changer(this.color);" name="velocity_supercheckout[customizer][button_border_color]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customizer']['button_border_color'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input"  onchange="text_changer(this.color);"name="velocity_supercheckout[customizer][button_text_color]"  value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customizer']['button_text_color'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input" onchange="border_bottom_changer(this.color);"name="velocity_supercheckout[customizer][border_bottom_color]"  value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customizer']['border_bottom_color'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"  />
...
"></i>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <textarea rows="5" style="resize: both;" class="vss_sc_ver15" name="velocity_supercheckout[custom_css]"><?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['custom_css'])) {?><?php echo $_smarty_tpl->tpl_vars['velocity_supercheckout']->value['custom_css'];?>
<?php }?></textarea>
                                                                        </td>                                                                        
                                                                    </tr>
                                                                    <tr>
...
"></i>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <textarea rows="5" style="resize: both;" class="vss_sc_ver15" name="velocity_supercheckout[custom_js]"><?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['custom_js'])) {?><?php echo $_smarty_tpl->tpl_vars['velocity_supercheckout']->value['custom_js'];?>
<?php }?></textarea>
                                                                        </td>                                                                        
                                                                    </tr>
...
"></i>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_supercheckout[fb_login][app_id]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['fb_login']['app_id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                        ...
                                                                        <td class="settings" >
                                                                            <input type="text" class="text-width" name="velocity_supercheckout[fb_login][app_secret]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['fb_login']['app_secret'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                    ...
                                                                    <tr style="display: none;">
                                                                        <td class="name vertical_top_align"><span class="control-label"><?php echo smartyTranslate(array('s'=>'Google App Id','mod'=>'supercheckout'),$_smarty_tpl);?>
: </span>                                                                
                                                                            <i class="icon-question-sign supercheckout-tooltip-color" data-toggle="tooltip"  data-placement="top" data-original-title="<?php echo smartyTranslate(array('s'=>'Google App Id Tooltip','mod'=>'supercheckout'),$_smarty_tpl);?>
"></i>
                                                                        </td>
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_supercheckout[google_login][app_id]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['google_login']['app_id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_supercheckout[google_login][client_id]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['google_login']['client_id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
...
"></i>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_supercheckout[google_login][app_secret]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['google_login']['app_secret'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
                                                                        ...
                                                                        <td class="settings">
                                                                            ...
                                                                            <div class="widget-body uniformjs" style="padding-top: 1%;">
                                                                                    ...
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option" name="velocity_supercheckout[mailchimp][default]" value="1" <?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['mailchimp']['default'])&&$_smarty_tpl->tpl_vars['velocity_supercheckout']->value['mailchimp']['default']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Subscribe customers as soon as they come out from Email field','mod'=>'supercheckout'),$_smarty_tpl);?>
...
"></i>
										...
										<span style="display: inline-block;width:75%;">
                                                                            <input type="text" class="text-width" name="velocity_supercheckout[mailchimp][api]" value="<?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['mailchimp']['api'])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['mailchimp']['api'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" id="supercheckout_mailchimp_key"/>
									    <input type="hidden" class="text-width" name="velocity_supercheckout[mailchimp][list]" value="<?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['mailchimp']['list'])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['mailchimp']['list'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>" id="supercheckout_mailchimp_list"/>
									    </span>
...
_input" class="sort-item" sort-data="<?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_personal'][$_smarty_tpl->tpl_vars['k']->value]['sort_order'])) {?><?php echo intval($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_personal'][$_smarty_tpl->tpl_vars['k']->value]['sort_order']);?>
<?php }?>">
...
" name="velocity_supercheckout[customer_personal][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][id]" />
...
<?php }?>" name="velocity_supercheckout[customer_personal][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][sort_order]" /></span>
                                                                            </td>
...
_require" type="checkbox" class="checkbox input-checkbox-option require_address_field" name="velocity_supercheckout[customer_personal][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_personal'][$_smarty_tpl->tpl_vars['k']->value]['guest']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_personal_guest_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_display" type="checkbox" class="checkbox input-checkbox-option display_address_field" name="velocity_supercheckout[customer_personal][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_personal'][$_smarty_tpl->tpl_vars['k']->value]['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_personal'][$_smarty_tpl->tpl_vars['k']->value]['logged']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_personal'][$_smarty_tpl->tpl_vars['k']->value]['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
_input" class="sort-item" sort-data="<?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_subscription'][$_smarty_tpl->tpl_vars['k']->value]['sort_order'])) {?><?php echo intval($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_subscription'][$_smarty_tpl->tpl_vars['k']->value]['sort_order']);?>
<?php }?>">
...
" name="velocity_supercheckout[customer_subscription][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][id]" />
...
<?php }?>" name="velocity_supercheckout[customer_subscription][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][sort_order]" /></span>
                                                                            </td>
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
...
_checked" type="checkbox" class="checkbox input-checkbox-option" name="velocity_supercheckout[customer_subscription][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_subscription'][$_smarty_tpl->tpl_vars['k']->value]['guest']['checked']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show as Checked','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_subsription_guest_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_display" type="checkbox" class="checkbox input-checkbox-option" name="velocity_supercheckout[customer_subscription][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['customer_subscription'][$_smarty_tpl->tpl_vars['k']->value]['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['use_delivery_for_payment_add']['guest']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show as Checked','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['show_use_delivery_for_payment_add']['guest']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['use_delivery_for_payment_add']['logged']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show as Checked','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['show_use_delivery_for_payment_add']['logged']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
_input" class="sort-item" sort-data="<?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_address'][$_smarty_tpl->tpl_vars['k']->value]['sort_order'])) {?><?php echo intval($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_address'][$_smarty_tpl->tpl_vars['k']->value]['sort_order']);?>
<?php }?>">
...
" name="velocity_supercheckout[shipping_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][id]" />
...
<?php }?>" name="velocity_supercheckout[shipping_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][sort_order]" /></span>
                                                                            </td>
...
_require" type="checkbox" class="checkbox input-checkbox-option require_address_field" name="velocity_supercheckout[shipping_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_address'][$_smarty_tpl->tpl_vars['k']->value]['guest']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
											<?php }?>
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="shipping_address_guest_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_display" type="checkbox" class="checkbox input-checkbox-option display_address_field" name="velocity_supercheckout[shipping_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_address'][$_smarty_tpl->tpl_vars['k']->value]['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_address'][$_smarty_tpl->tpl_vars['k']->value]['logged']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_address'][$_smarty_tpl->tpl_vars['k']->value]['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
_input" class="sort-item" sort-data="<?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_address'][$_smarty_tpl->tpl_vars['k']->value]['sort_order'])) {?><?php echo intval($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_address'][$_smarty_tpl->tpl_vars['k']->value]['sort_order']);?>
<?php }?>">
...
" name="velocity_supercheckout[payment_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][id]" />
...
<?php }?>" name="velocity_supercheckout[payment_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][sort_order]" /></span>
                                                                            </td>
...
_require" type="checkbox" class="checkbox input-checkbox-option require_address_field" name="velocity_supercheckout[payment_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_address'][$_smarty_tpl->tpl_vars['k']->value]['guest']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>

											<?php }?>
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="payment_address_guest_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_display" type="checkbox" class="checkbox input-checkbox-option display_address_field" name="velocity_supercheckout[payment_address][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_address'][$_smarty_tpl->tpl_vars['k']->value]['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_address'][$_smarty_tpl->tpl_vars['k']->value]['logged']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_address'][$_smarty_tpl->tpl_vars['k']->value]['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
"></i>
                                                                    ...
                                                                    <td class="left settings">
                                                                        <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[payment_method][display_style]" value="0"  <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_method']['display_style']==0) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Text Only','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[payment_method][display_style]" value="1" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_method']['display_style']==1) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Text With Image','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[payment_method][display_style]" value="2" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['payment_method']['display_style']==2) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Image Only','mod'=>'supercheckout'),$_smarty_tpl);?>
...
);" value='<?php echo smartyTranslate(array('s'=>'Remove','mod'=>'supercheckout'),$_smarty_tpl);?>
...
_msg" style="margin-left:10px; display:none;"><?php echo smartyTranslate(array('s'=>'Only Images allowed','mod'=>'supercheckout'),$_smarty_tpl);?>
				...
				<div style="margin-top: 10px;display:flex;padding-left: 10px;">
					...
					<div class="input-group" style="width: 20%;"><input type="text"  class="form-control" name="velocity_supercheckout_payment[payment_method][<?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
][logo][resolution][width]" value="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
...
<?php } else { ?>auto<?php }?>"/><span class="input-group-addon" style="width: 10px;"><?php echo smartyTranslate(array('s'=>'px','mod'=>'supercheckout'),$_smarty_tpl);?>
</span></div>
					<span style="padding: 5px 10px 0px 10px;"><?php echo smartyTranslate(array('s'=>'Height','mod'=>'supercheckout'),$_smarty_tpl);?>
</span>		<div class="input-group" style="width: 20%;"><input type="text" class="form-control"  name="velocity_supercheckout_payment[payment_method][<?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
][logo][resolution][height]" value="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
...
"></i>
                                                                    ...
                                                                    <td class="left settings">
                                                                        <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[shipping_method][display_style]" value="0"  <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_method']['display_style']==0) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Text Only','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[shipping_method][display_style]" value="1" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_method']['display_style']==1) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Text With Image','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[shipping_method][display_style]" value="2" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['shipping_method']['display_style']==2) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Image Only','mod'=>'supercheckout'),$_smarty_tpl);?>
...
_msg" style="margin-left:10px; display:none;"><?php echo smartyTranslate(array('s'=>'Only Images allowed','mod'=>'supercheckout'),$_smarty_tpl);?>
				...
				<div style="margin-top: 10px;display:flex;padding-left: 10px;">
					...
					<div class="input-group" style="width: 20%;">
						<input type="text"  class="form-control" name="velocity_supercheckout_payment[delivery_method][<?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
][logo][resolution][width]" value="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
...
<?php } else { ?>auto<?php }?>"/><span class="input-group-addon" style="width: 10px;"><?php echo smartyTranslate(array('s'=>'px','mod'=>'supercheckout'),$_smarty_tpl);?>
		...
		<span style="padding: 5px 10px 0px 10px;"><?php echo smartyTranslate(array('s'=>'Height','mod'=>'supercheckout'),$_smarty_tpl);?>
</span>		<div class="input-group" style="width: 20%;">		<input type="text" class="form-control"  name="velocity_supercheckout_payment[delivery_method][<?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
][logo][resolution][height]" value="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
...
<?php $_tmp34=ob_get_clean();?><?php if (isset($_smarty_tpl->tpl_vars['velocity_supercheckout']->value[$_tmp31][$_tmp32])&&$_smarty_tpl->tpl_vars['velocity_supercheckout']->value[$_tmp33][$_tmp34]==1) {?>
								    <div style="border: 1px solid #B13131;background-color: rgb(224, 69, 69)" class="ship2pay-div" id="velocity_supercheckout[<?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
][<?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
]">
								    <input style="display:none;" type="checkbox" name="velocity_supercheckout[<?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
][<?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
								    ...
								    <?php } else { ?>
								    <div style="border: 1px solid #257925;background-color: rgb(83, 199, 83);" class="ship2pay-div" id="velocity_supercheckout[<?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
][<?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
]">
								    <input style="display:none;" type="checkbox" name="velocity_supercheckout[<?php echo intval($_smarty_tpl->tpl_vars['carrier']->value['id_carrier']);?>
][<?php echo intval($_smarty_tpl->tpl_vars['pay_methods']->value['id_module']);?>
...
" name="velocity_supercheckout[cart_options][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][id]" />
...
<?php }?>" name="velocity_supercheckout[cart_options][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][sort_order]" /></span></td>
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option" name="velocity_supercheckout[cart_options][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['cart_options'][$_smarty_tpl->tpl_vars['k']->value]['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['cart_options'][$_smarty_tpl->tpl_vars['k']->value]['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
"></i></td>
                                                                        <td class="left drag-col-2 col-pad-left">
                                                                                <div class='span1'><input type='text' <?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>class="form-control vss-form-control-ver15"<?php }?> name='velocity_supercheckout[cart_image_size][width]' value='<?php echo intval($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['cart_image_size']['width']);?>
' /></div>
                                                                                <div class="span0<?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?> vss-resolution-ver15<?php }?>">X</div>
                                                                                <div class='span1'><input type='text' <?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>class="form-control vss-form-control-ver15"<?php }?> name='velocity_supercheckout[cart_image_size][height]' value='<?php echo intval($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['cart_image_size']['height']);?>
' /></div>
                                                                        </td>
                                                                        <td class="left drag-col-2">
...
"></i></td>
                                                                        <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[qty_update_option]" value="0"  <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['qty_update_option']==0) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'+/- Button','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio" name="velocity_supercheckout[qty_update_option]" value="1" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['qty_update_option']==1) {?> checked="checked" <?php }?> /><?php echo smartyTranslate(array('s'=>'Update Link','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['product_sub_total']['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['product_sub_total']['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['voucher']['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['voucher']['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['shipping_price']['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['shipping_price']['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['total']['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['order_total_option']['total']['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['term_condition']['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['term_condition']['guest']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['term_condition']['guest']['checked']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show as Checked','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['term_condition']['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['term_condition']['logged']['require']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Require','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['term_condition']['logged']['checked']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show as Checked','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['order_comment_box']['guest']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['confirm']['order_comment_box']['logged']['display']==1) {?>checked="checked"<?php }?> /><?php echo smartyTranslate(array('s'=>'Show','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                    ...
                                                    <div id="tab_design" class="tab-pane tab-form">
                                                        <div class="block">
                                                            <h4 class='velsof-tab-heading'><?php echo smartyTranslate(array('s'=>'Design','mod'=>'supercheckout'),$_smarty_tpl);?>
                                                                ...
                                                                <div class="span3">
                                                                    <select <?php if ($_smarty_tpl->tpl_vars['ps_version']->value==15) {?>class="selectpicker vss_sc_ver15"<?php }?> name="velocity_supercheckout[layout]" onchange='$.cookie("designTab",1); location.href = "<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['action']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
"  type="hidden"  class="sort col-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][1_column][column]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['1_column']['column'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort row-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][1_column][row]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['1_column']['row'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort col-data-inside" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][1_column][column-inside]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['1_column']['column-inside'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort col-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][2_column][column]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['2_column']['column'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort row-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][2_column][row]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['2_column']['row'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort col-data-inside" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][2_column][column-inside]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['2_column']['column-inside'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort col-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][3_column][column]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['3_column']['column'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort row-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][3_column][row]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['3_column']['row'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
"  type="hidden"  class="sort col-data-inside" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][3_column][column-inside]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design']['html'][$_smarty_tpl->tpl_vars['k']->value]['3_column']['column-inside'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                        <?php } ?>
...
?>
                                                                                <input   type="hidden"  class="sort col-data" name="velocity_supercheckout[design][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['col_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][column]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design'][$_smarty_tpl->tpl_vars['tab_name']->value][$_smarty_tpl->tpl_vars['col_name']->value]['column'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                <input   type="hidden"  class="sort row-data" name="velocity_supercheckout[design][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['col_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][row]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design'][$_smarty_tpl->tpl_vars['tab_name']->value][$_smarty_tpl->tpl_vars['col_name']->value]['row'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                <input   type="hidden"  class="sort col-data-inside" name="velocity_supercheckout[design][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['col_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][column-inside]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['design'][$_smarty_tpl->tpl_vars['tab_name']->value][$_smarty_tpl->tpl_vars['col_name']->value]['column-inside'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                            <?php } ?>
                                                                            <?php }?>
                                                                        <?php } ?>                                                                
                                                                        ...
                                                                        <!-- Start - Header and footer Html -->                                                                    
                                                                            <input type="hidden" id="modals_bootbox_prompt_html_header_value" name="velocity_supercheckout[html_value][header]" value="<?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['html_value']['header']!='') {?><?php echo htmlspecialchars(html_entity_decode($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['html_value']['header']), ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
                                                                            <input type="hidden" id="modals_bootbox_prompt_html_footer_value" name="velocity_supercheckout[html_value][footer]" value="<?php if ($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['html_value']['footer']!='') {?><?php echo htmlspecialchars(html_entity_decode($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['html_value']['footer']), ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
                                                                        ...
                                                                        <?php if ($_smarty_tpl->tpl_vars['layout']->value==1) {?>
                                                                            ...
                                                                            <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars['tab_name'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value) {
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['tab_name']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
                                                                                <input type="hidden"  class="column-data-1 col" name="velocity_supercheckout[column_width][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width'][$_smarty_tpl->tpl_vars['tab_name']->value][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width'][$_smarty_tpl->tpl_vars['tab_name']->value][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][3]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width'][$_smarty_tpl->tpl_vars['tab_name']->value][3], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                <input type="hidden"  class="column-data-3 col" name="velocity_supercheckout[column_width][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][inside][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width'][$_smarty_tpl->tpl_vars['tab_name']->value]['inside'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                <input type="hidden"  class="column-data-3 col" name="velocity_supercheckout[column_width][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tab_name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][inside][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width'][$_smarty_tpl->tpl_vars['tab_name']->value]['inside'][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                            <?php } ?>
...
">
                                                                                        <div class="portlet-header"><i class="icon-small-confirm"></i><?php echo smartyTranslate(array('s'=>'Html Content','mod'=>'supercheckout'),$_smarty_tpl);?>
</div>
                                                                                        <div class="portlet-content">
                                                                                            <div class="text"><?php echo smartyTranslate(array('s'=>'Extra html content','mod'=>'supercheckout'),$_smarty_tpl);?>
</div>
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
...
"  type="text"  class="sort row-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" id="modals_bootbox_prompt_html_header" data-toggle="modal" class="glyphicons edit bootbox-design-edit-html" ><i></i></a>
                                                                                ...
                                                                                <div class="columns">
                                                                                    <input type="hidden"  class="column-data-1 col" name="velocity_supercheckout[column_width][1_column][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['1_column'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][1_column][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['1_column'][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][1_column][3]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['1_column'][3], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-3 col" name="velocity_supercheckout[column_width][1_column][inside][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['1_column']['inside'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-3 col" name="velocity_supercheckout[column_width][1_column][inside][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['1_column']['inside'][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />

                                                                                    <input type="hidden"  class="column-data-1 col" name="velocity_supercheckout[column_width][3_column][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['3_column'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][3_column][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['3_column'][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][3_column][3]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['3_column'][3], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-3 col" name="velocity_supercheckout[column_width][3_column][inside][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['3_column']['inside'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="hidden"  class="column-data-3 col" name="velocity_supercheckout[column_width][3_column][inside][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['3_column']['inside'][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />

                                                                                    <input type="hidden"  class="column-data-2 col" name="velocity_supercheckout[column_width][2_column][3]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['2_column'][3], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />

                                                                                    <input type="text" id="column-1-text"  class="column-data-1 col velsof-column-2-input" name="velocity_supercheckout[column_width][2_column][1]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['2_column'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                    <input type="text" id="column-2-text" class="column-data-2 col velsof-column-2-input" name="velocity_supercheckout[column_width][2_column][2]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['column_width']['2_column'][2], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                                                                                </div>
...
"   type="text"  class="sort col-data" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" />
                                                                                                <input id="col_inside_text_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"  type="text"  class="sort col-data-inside" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" id="modals_bootbox_prompt_html_footer" data-toggle="modal" class="glyphicons edit bootbox-design-edit-html" ><i></i></a>
                                                    ...
                                                    <!--------------- End - Design -------------------->
                                                    <input type="hidden" id="modal_value" name="velocity_supercheckout[modal_value]" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['velocity_supercheckout']->value['modal_value'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
...
" name="velocity_supercheckout[design][html][<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
][value]" value="<?php ob_start();?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'utf-8', true), "HTML-ENTITIES", 'utf-8');?>
...
" />
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="name vertical_top_align"><span>Take advantage of our exclusive offers Text <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['label']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
: </span></td>
                                                                                        <td class="velsof-english"><?php if (isset($_smarty_tpl->tpl_vars['current_lang_translator_vars']->value['front_validation_msg12']['label'][1])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['current_lang_translator_vars']->value['front_validation_msg12']['label'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php } else { ?>Take advantage of our exclusive offers<?php }?></td>
                                                                                        <td class="left">
                                                                                            ...
                                                                                            <input type="text" class="translator_input_width" name="velocity_transalator[front_validation_msg12][label][]" value="<?php if (isset($_smarty_tpl->tpl_vars['selected_lang_translator_vars']->value['front_validation_msg12']['label'][1])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['selected_lang_translator_vars']->value['front_validation_msg12']['label'][1], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php } else { ?>Take advantage of our exclusive offers<?php }?>" />

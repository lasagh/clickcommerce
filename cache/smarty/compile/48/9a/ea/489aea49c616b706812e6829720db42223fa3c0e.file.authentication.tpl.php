<?php /* Smarty version Smarty-3.1.19, created on 2016-11-28 15:33:51
         compiled from "/Applications/MAMP/htdocs/clickcommerce/vp1/modules/fkcustomers/views/front/v1_6_1_1/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1518899216583c6a7f38a4e5-73323005%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '489aea49c616b706812e6829720db42223fa3c0e' => 
    array (
      0 => '/Applications/MAMP/htdocs/clickcommerce/vp1/modules/fkcustomers/views/front/v1_6_1_1/authentication.tpl',
      1 => 1446541562,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1518899216583c6a7f38a4e5-73323005',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583c6a7fc8c6b4_86020776',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583c6a7fc8c6b4_86020776')) {function content_583c6a7fc8c6b4_86020776($_smarty_tpl) {?>
...
?>
						<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company") {?>
							...
							<div class="form-group" id="fkcustomers_company" <?php if (isset($_POST['tipo'])&&$_POST['tipo']=='pj') {?> style="display: block" <?php } else { ?> style="display: none"<?php }?>>
...
<?php }?>" />
 ...
 <sup>*</sup></label>
                                ...
                                <input type="hidden" class="form-control" name="postcode" id="postcode" value="<?php if (isset($_POST['postcode'])) {?><?php echo $_POST['postcode'];?>
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
 ...
 <sup>*</sup></label>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="numend") {?>
                            <div class="required form-group">
...
<?php }?>"/>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="compl") {?>
                            <div class="form-group">
